...
frameDatos = FrmDatos(app).grid(row=1, column=0,columnspan=6, sticky="nsew",padx=2,pady=2)
frameTablaSelecciones = FrmTablaSelecciones(app).grid(row=2, column=0,columnspan=5, sticky="nsew",padx=2,pady=2)
frameBotones = FrmBotones(app).grid(row=2, column=5, sticky="nsew",padx=2,pady=2)
